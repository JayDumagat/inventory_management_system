...
export function Card({ children, className }: CardProps) {
  return (
    <div className={cn("ui-surface ui-card bg-panel border border-stroke", className)}>
      {children}
    </div>
  );
}
...
export function CardHeader({ children, className }: CardHeaderProps) {
  return <div className={cn("card-content-spacing border-b border-stroke", className)}>{children}</div>;
}
...
export function CardContent({ children, className }: CardContentProps) {
  return <div className={cn("card-content-spacing", className)}>{children}</div>;
}
