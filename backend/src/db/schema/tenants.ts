...
export const tenants = pgTable("tenants", {
  ...
  brandingAccent: text("branding_accent").default("blue"),
  ...
  secRegNumber: text("sec_reg_number"),
  dtiRegNumber: text("dti_reg_number"),
  businessPermitNumber: text("business_permit_number"),
  isVatRegistered: boolean("is_vat_registered").notNull().default(false),
  businessType: text("business_type").default("sole_proprietorship"),
  businessAddress: text("business_address"),
  businessCity: text("business_city"),
  businessCountry: text("business_country").default("PH"),
